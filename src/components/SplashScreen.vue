...
onMounted(() => {
    ambientAudio = new Audio('https://sound-effects-media.bbcrewind.co.uk/mp3/NHU05080068.mp3?download&rename=BBC_Waves---Wa_NHU0508006');
...
.splash-logo {
    ...
    filter: drop-shadow(0 0 10px rgba(255, 255, 255, 0.6)) drop-shadow(0 0 20px rgba(0, 0, 0, 0.4));
}
...
@keyframes bgFade {
    ...
    60% {
        background: rgba(150, 230, 220, 0.2);
    }
    100% {
